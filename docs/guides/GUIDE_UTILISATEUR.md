...
#### 🔔 Notifications actionnables (NOUVEAU !)

Depuis les notifications, vous pouvez **agir directement** sans ouvrir l'application :

| Type de notification | Boutons disponibles |
|---------------------|---------------------|
| **🐰 Mise bas** | ✅ Fait · ❌ Échec · ⏰ Reporter |
| **🔍 Palpation** | ✅ Gestante · ❌ Non gestante · 🔄 Refaire |
| **🏠 Nid** | ✅ Fait · ⏰ Reporter |
| **👶 Sevrage** | ✅ Fait · ⏰ Reporter |
| **⚖️ Pesée** | ✅ OK · ⚠️ Problème · ⏰ Reporter |
| **💉 Soin** | ✅ Fait · ⏰ Reporter |

**Comment ça marche :**
1. Recevez la notification sur votre téléphone
2. **Sans ouvrir l'app** : appuyez sur un bouton
3. L'action est enregistrée automatiquement dans la base de données
4. Les notifications suivantes sont replanifiées si nécessaire

**Exemple - Mise bas :**
- Appuyer sur "✅ Fait" → L'accouplement est marqué terminé + rappel pour enregistrer la portée
- Appuyer sur "❌ Échec" → L'accouplement est marqué échoué + notifications annulées
- Appuyer sur "⏰ Reporter" → Nouvelle notification dans 24h
